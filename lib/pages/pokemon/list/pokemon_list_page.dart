...
import 'package:demo_app/utils/app_manager.dart';
...
class PokemonListPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
        appBar: AppBar(
          // タイトルテキスト
          title: Text('Pokemon List .' + AppManager.flavor().toString().split(".")[1].toUpperCase()),
          actions: <Widget>[
            IconButton(
        ...
        body: mode == DisplayMode.list
            ...
            : GridView.builder(
                gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 3, crossAxisSpacing: 16),
